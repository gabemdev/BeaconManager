...
class BeaconsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beacon" do
    assert_difference('Beacon.count') do
      post beacons_url, params: { beacon: { alertMessage: @beacon.alertMessage, alertTitle: @beacon.alertTitle, major: @beacon.major, minor: @beacon.minor, uuid: @beacon.uuid } }
    end
  ...
  test "should update beacon" do
    patch beacon_url(@beacon), params: { beacon: { alertMessage: @beacon.alertMessage, alertTitle: @beacon.alertTitle, major: @beacon.major, minor: @beacon.minor, uuid: @beacon.uuid } }
